...
public class Enemy_Bullet_Ctrl : MonoBehaviour
{
    ...
    void OnParticleCollision(GameObject other)
    {
        ...
        for (int i = 0; i < numCollisionEvents; i++)
        {
            ...
            {
                var instance = Pool.Instance.Spawn("Enemy_BulletHit", collisionEvents[i].intersection + collisionEvents[i].normal * Offset, new Quaternion()) as GameObject;
